    ...
    return (
        <>
            ...
            <Input
                ...
                onChange={(e) =>
                    dispatch(setSignUpRequest({ firstName: e.target.value }))
                }
            ...
            <Input
                ...
                onChange={(e) =>
                    dispatch(setSignUpRequest({ lastName: e.target.value }))
                }
            ...
            <Dropdown isBordered>
                <Dropdown.Button>
                    ...
                    {
                        genderList.find(
                            (item) => item.value === signUpRequest.gender
                        )?.label
                    }
                </Dropdown.Button>
                <Dropdown.Menu
                    ...
                    {genderList.map((item) => (
                        <Dropdown.Item key={item.value}>
                            <div
                                onClick={() =>
                                    dispatch(
                                        setSignUpRequest({ gender: item.value })
                                    )
                                }
                            >
                                {item.label}
            ...
            <Input
                ...
                onChange={(e) =>
                    dispatch(setSignUpRequest({ dob: e.target.value }))
                }
