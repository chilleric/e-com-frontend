...
export const UserDetail = () => {
    ...
    const [UserState, setUserState] =
        useState<UserResponseSuccess>(DefaultUser);
                        ...
                        <>
                            ...
                            <Dropdown isBordered>
                                ...
                                <Dropdown.Menu
                                    ...
                                    selectedKeys={
                                        new Set([UserState.deleted.toString()])
                                    }
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    if (viewResult?.data?.result)
                                        setUserState(viewResult.data.result);
                                    setType("read");
                                }}
                            >
                                Cancel
